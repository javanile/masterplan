...
function qa(a,b){a.h={La:b,xa:!0};a.f=a.l||a.j}
...
function ya(a){for(;a.f.f;)try{var b=a.g(a.f);if(b)return a.f.m=!1,{value:b.value,done:!1}}catch(c){a.f.g=void 0,qa(a.f,c)}a.f.m=!1;if(a.f.h){b=a.f.h;a.f.h=null;if(b.xa)throw b.La;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
b.prototype.then=function(g,h){function k(r,t){return"function"==typeof r?function(A){try{l(r(A))}catch(D){m(D)}}:t}
...
b.all=function(g){var h=u(g),k=h.next();return k.done?d([]):new b(function(l,m){function p(A){return function(D){r[A]=D;t--;0==t&&l(r)}}
...
n.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Nb;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.ya}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.f.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(F()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
function b(p){for(var r=g,t=0;64>t;t+=4)r[t/4]=p[t]<<24|p[t+1]<<16|p[t+2]<<8|p[t+3];for(t=16;80>t;t++)p=r[t-3]^r[t-8]^r[t-14]^r[t-16],r[t]=(p<<1|p>>>31)&4294967295;p=e[0];var A=e[1],D=e[2],X=e[3],Fd=e[4];for(t=0;80>t;t++){if(40>t)if(20>t){var cb=X^A&(D^X);var hc=1518500249}else cb=A^D^X,hc=1859775393;else 60>t?(cb=A&D|X&(A|D),hc=2400959708):(cb=A^D^X,hc=3395469782);cb=((p<<5|p>>>27)&4294967295)+cb+Fd+hc+r[t]&4294967295;Fd=X;X=D;D=(A<<30|A>>>2)&4294967295;A=p;p=cb}e[0]=e[0]+p&4294967295;e[1]=e[1]+
A&4294967295;e[2]=e[2]+D&4294967295;e[3]=e[3]+X&4294967295;e[4]=e[4]+Fd&4294967295}
function c(p,r){if("string"===typeof p){p=unescape(encodeURIComponent(p));for(var t=[],A=0,D=p.length;A<D;++A)t.push(p.charCodeAt(A));p=t}r||(r=p.length);t=0;if(0==l)for(;t+64<r;)b(p.slice(t,t+64)),t+=64,m+=64;for(;t<r;)if(f[l++]=p[t++],m++,64==l)for(l=0,b(f);t+64<r;)b(p.slice(t,t+64)),t+=64,m+=64}
...
for(var e=[],f=[],g=[],h=[128],k=1;64>k;++k)h[k]=0;var l,m;a();return{reset:a,update:c,digest:d,Ka:function(){for(var p=d(),r="",t=0;t<p.length;t++)r+="0123456789ABCDEF".charAt(Math.floor(p[t]/16))+"0123456789ABCDEF".charAt(p[t]%16);return r}}}
...
function fd(a){var b=dd();b.update(a);return b.Ka().toLowerCase()}
...
var md;
function nd(){var a=y.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&!J("Presto")&&(a=function(){var e=Lc(document,"IFRAME");e.style.display="none";document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.close();var g="callImmediate"+Math.random(),h="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=E(function(k){if(("*"==h||k.origin==h)&&k.data==g)this.port1.onmessage()},this);
...
return a[Ae]}
;function Be(){M.call(this);this.f=new ie(this);this.i=this;this.h=null}
...
Be.prototype.dispatchEvent=function(a){var b=this.h;if(b){var c=[];for(var d=1;b;b=b.h)c.push(b),++d}b=this.i;d=a.type||a;if("string"===typeof a)a=new be(a,b);else if(a instanceof be)a.target=a.target||b;else{var e=a;a=new be(d,b);pb(a,e)}e=!0;if(c)for(var f=c.length-1;!a.g&&0<=f;f--){var g=a.f=c[f];e=Ce(g,d,!0,a)&&e}a.g||(g=a.f=b,e=Ce(g,d,!0,a)&&e,a.g||(e=Ce(g,d,!1,a)&&e));if(c)for(f=0;!a.g&&f<c.length;f++)g=a.f=c[f],e=Ce(g,d,!1,a)&&e;return e};
Be.prototype.o=function(){Be.I.o.call(this);if(this.f){var a=this.f,b=0,c;for(c in a.listeners){for(var d=a.listeners[c],e=0;e<d.length;e++)++b,he(d[e]);delete a.listeners[c];a.f--}}this.h=null};
...
function Bg(a){var b=void 0===a?{}:a;a=void 0===b.Qa?!0:b.Qa;b=void 0===b.eb?!1:b.eb;if(null==B("_lact",window)){var c=parseInt(Q("LACT"),10);c=isFinite(c)?F()-Math.max(c,0):-1;z("_lact",c,window);z("_fact",c,window);-1==c&&Cg();wg(document,"keydown",Cg);wg(document,"keyup",Cg);wg(document,"mousedown",Cg);wg(document,"mouseup",Cg);a&&(b?wg(window,"touchmove",function(){Dg("touchmove",200)},{passive:!0}):(wg(window,"resize",function(){Dg("resize",200)}),wg(window,"scroll",function(){Dg("scroll",200)})));
...
function Sg(){for(var a=Kg,b=Math.round(U()),c=u(Pg),d=c.next();!d.done;d=c.next()){var e=u(d.value);d=e.next().value;var f=e.next().value;e=nb({context:Ug(a.f||Vg())});e.events=f;(f=Qg[d])&&Wg(e,d,f);delete Qg[d];Xg(e,b);Yg(a,"log_event",e,{retry:!0,onSuccess:function(){Jg=Math.round(U()-b)}});
Og=!1}}
...
b.Ca&&0<b.timeout&&(f=T(function(){e||(e=!0,Mf(f),b.Ca.call(b.context||y))},b.timeout))}else wh(a,b)}
...
function Vg(){return{innertubeApiKey:Q("INNERTUBE_API_KEY",void 0),innertubeApiVersion:Q("INNERTUBE_API_VERSION",void 0),Ra:Q("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Sa:Q("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:Q("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Ua:Q("INNERTUBE_CONTEXT_HL",void 0),Ta:Q("INNERTUBE_CONTEXT_GL",void 0),Va:Q("INNERTUBE_HOST_OVERRIDE",void 0)||"",Xa:!!Q("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Wa:!!Q("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:Q("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function Ug(a){var b={client:{hl:a.Ua,gl:a.Ta,clientName:a.Sa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ra}},c=window.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=Q("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=Q("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=Q("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
...
v(Th,Error);var Uh={},Vh=(Uh.ABORT="Transaction was aborted",Uh.AUTH_INVALID="No user identifier specified.",Uh.IDB_NOT_SUPPORTED="IndexedDB is not supported.",Uh.MISSING_OBJECT_STORE="Object store not created.",Uh.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",Uh.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",Uh);
function Wh(a,b,c){b=void 0===b?{}:b;c=void 0===c?Vh[a]:c;Th.call(this,c,Object.assign(Object.assign({},b),{name:"YtIdbKnownError",type:a}));this.type=a;this.message=c;Object.setPrototypeOf(this,Wh.prototype)}
v(Wh,Th);function Xh(a){Wh.call(this,"MISSING_OBJECT_STORE",{Lb:a},Vh.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,Xh.prototype)}
v(Xh,Wh);function Yh(a){return a instanceof DOMException?"VersionError"===a.name:"DOMError"in self&&a instanceof DOMError?"VersionError"===a.name:a instanceof Object&&"message"in a?"An attempt was made to open a database using a lower version than the existing version."===a.message:!1}
;function Zh(a){if(!a)throw Error();throw a;}
...
b.f.addEventListener("abort",function(){var e=b.f.error;e?("QuotaExceededError"===e.name?Cf(new Wh("QUOTA_EXCEEDED")):"UnknownError"===e.name&&Cf(new Wh("QUOTA_MAYBE_EXCEEDED")),d(e)):d(new Wh("ABORT"))})})}
...
ni.prototype.abort=function(){this.f.abort();this.aborted=!0;throw new Wh("ABORT");};
...
;function Di(a,b){for(var c=u(Object.keys(b.Za)),d=c.next();!d.done;d=c.next())if(d=d.value,!a.f.objectStoreNames.contains(d))return d}
...
throw new Xh(g);}}return f}),function(f){if(Yh(f))return a.ra(a.name,void 0,Object.assign(Object.assign({},c),{upgrade:void 0}));
b();throw f;})};
var e=d();this.va(b);this.f=e}return this.f};function Fi(a){if(0<=a.indexOf(":"))throw Error("Database name cannot contain ':'");}
;var Gi;function Hi(){function a(b){b.close();Gi=void 0}
Gi||(Gi=Ue(ui("YtIdbMeta",1,{blocking:a,upgrade:function(b,c){1>c&&ki(b,"databases",{keyPath:"actualName"})}}),function(b){return Yh(b)?ui("YtIdbMeta",void 0,{blocking:a}):Pe(b)}));
return Gi}
function Ii(a){return Hi().then(function(b){return b.get("databases",a.actualName).then(function(c){if(c?a.actualName!==c.actualName||a.publicName!==c.publicName||a.userIdentifier!==c.userIdentifier||a.signedIn!==c.signedIn:1)return mi(b,a)})})}
function Ji(a){return Hi().then(function(b){return b["delete"]("databases",a)})}
;function Ki(a){return{actualName:a,publicName:a,userIdentifier:void 0,signedIn:!1}}
function Li(a){return Ki(a);throw new Wh("AUTH_INVALID");}
function Mi(a,b,c){Fi(a);var d;try{b?d=Ki(a):d=Li(a)}catch(e){return Pe(e)}return Ue(Ii(d).then(function(){return c(d)}),function(e){return Ue(Ji(d.actualName),function(){}).then(function(){return Pe(e)})})}
function Ni(){return Bi().then(function(a){if(!a)throw new Wh("IDB_NOT_SUPPORTED");})}
function Oi(a,b,c){c=void 0===c?{}:c;return Ni().then(function(){return Mi(a,!1,function(d){return ui(d.actualName,b,c)})})}
function Pi(a,b,c){c=void 0===c?{}:c;return Ni().then(function(){return Mi(a,!0,function(d){return ui(d.actualName,b,c)})})}
function Qi(a,b){b=void 0===b?{}:b;Fi(a);var c;return Ni().then(function(){c=Li(a);return vi(c.actualName,b)}).then(function(){return Ji(c.actualName)})}
function Ri(a,b){b=void 0===b?{}:b;Fi(a);return Ni().then(function(){return vi(a,b)}).then(function(){return Ji(a)})}
;function Si(a,b){Ei.call(this,a,b);this.options=b;Fi(a)}
v(Si,Ei);Si.prototype.ra=function(a,b,c){c=void 0===c?{}:c;return(this.options.pb?Pi:Oi)(a,b,c)};
Si.prototype.va=function(a){Oh.f.add("authchanged",a,!0,void 0,void 0)};
Si.prototype.wa=function(a){Oh.f.remove("authchanged",a,void 0,void 0)};
Si.prototype["delete"]=function(a){a=void 0===a?{}:a;return(this.options.pb?Ri:Qi)(this.name,a)};function Ti(){V.call(this,function(){});
throw Error("Not allowed to instantiate the thennable outside of the core library.");}
v(Ti,V);Ti.reject=V.reject;Ti.resolve=V.resolve;Ti.all=V.all;var Ui={},Vi=function(a,b){var c;return function(){c||(c=new Si(a,b));return c}}("LogsDataBase",{Za:(Ui.LogsRequestsStore=!0,Ui.sapisid=!0,Ui),
...
version:1});function Wi(a){return K(this,function c(){var d,e,f;return x(c,function(g){if(1==g.f)return w(g,Xi(),2);if(3!=g.f)return d=g.g,w(g,Vi().open(),3);e=g.g;f=Object.assign(Object.assign({},a),{options:JSON.parse(JSON.stringify(a.options)),authHash:d});return g["return"](e.add("LogsRequestsStore",f))})})}
function Yi(){return K(this,function b(){var c,d,e,f,g,h;return x(b,function(k){switch(k.f){case 1:return w(k,Xi(),2);case 2:return c=k.g,d=["NEW",c,0],e=["NEW",c,U()],f=IDBKeyRange.bound(d,e),w(k,Vi().open(),3);case 3:return g=k.g,h=void 0,w(k,ii(g,["LogsRequestsStore"],"readwrite",function(l){return qi(ji(l,"LogsRequestsStore").index("newRequest"),{query:f,direction:"prev"},function(m){m.getValue()&&(h=m.getValue(),h.status="QUEUED",m.update(h))})}),4);
case 4:return k["return"](h)}})})}
function Zi(a){return K(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Vi().open(),2);d=e.g;return e["return"](ii(d,["LogsRequestsStore"],"readwrite",function(f){var g=ji(f,"LogsRequestsStore");return g.get(a).then(function(h){if(h)return h.status="QUEUED",W(g.f.put(h,void 0)).then(function(){return h})})}))})})}
function $i(a){return K(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Vi().open(),2);d=e.g;return e["return"](ii(d,["LogsRequestsStore"],"readwrite",function(f){var g=ji(f,"LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",h.sendCount+=1,W(g.f.put(h,void 0)).then(function(){return h})):Ti.resolve(void 0)})}))})})}
function aj(a){return K(this,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Vi().open(),2);d=e.g;return e["return"](d["delete"]("LogsRequestsStore",a))})})}
function Xi(){return K(this,function b(){var c;return x(b,function(d){if(1==d.f){Nh.f||(Nh.f=new Nh);var e={};var f=gd([]);f&&(e.Authorization=f,e["X-Goog-AuthUser"]=Q("SESSION_INDEX",0),"INNERTUBE_HOST_OVERRIDE"in xf||(e["X-Origin"]=window.location.origin),S("pageid_as_header_web")&&"DELEGATED_SESSION_ID"in xf&&(e["X-Goog-PageId"]=Q("DELEGATED_SESSION_ID")));e=Oe(e);return w(d,e,2)}c=d.g;return d["return"](Gh(c))})})}
;var bj=Hf("network_polling_interval",3E4);function cj(){this.i=0;this.f=dj();ej(this);fj(this)}
function gj(){cj.f||(cj.f=new cj);return cj.f}
function hj(a){a.f!==dj()&&R(Error("NetworkStatusManager isOnline does not match window status"));return a.f}
function ij(a){var b=jj,c=kj;(new N(function(d){a.g=d})).then(function(){b();
c&&(a.h=c)});
lj(a)}
function dj(){var a=window.navigator.onLine;return void 0===a?!0:a}
function fj(a){window.addEventListener("online",function(){a.f=!0;a.g&&a.g()})}
function ej(a){window.addEventListener("offline",function(){a.f=!1;a.h&&a.h()})}
function lj(a){a.i||(mj(a),dj()&&a.g&&a.g())}
function mj(a){a.i=gg(function(){dj()?(!1===a.f&&R(Error("NetworkStatusManager missed online event.")),a.f=!0,a.g&&a.g()):(!0===a.f&&R(Error("NetworkStatusManager missed offline event.")),a.f=!1,a.h&&a.h());mj(a)},bj)}
;var nj=Hf("networkless_throttle_timeout")||100,oj=Hf("networkless_retry_attempts")||1,pj=0;function qj(a,b){b=void 0===b?{}:b;rj().then(function(c){var d=hj(gj());if(!c||S("networkless_bypass_write")||d&&S("vss_networkless_bypass_write"))wh(a,b);else{var e={url:a,options:b,timestamp:U(),status:"NEW",sendCount:0};Wi(e).then(function(f){e.id=f;f=gj();hj(f)&&!S("networkless_always_offline")?sj(e):ij(f)})["catch"](function(f){sj(e);
R(f)})}})}
function jj(){var a=this;pj||(pj=ig(function(){return K(a,function c(){var d;return x(c,function(e){if(1==e.f)return w(e,Yi(),2);if(3!=e.f)return d=e.g,d?w(e,sj(d),3):(kj(),e["return"]());pj=0;jj();e.f=0})})},nj))}
function kj(){kg(pj);pj=0}
function sj(a){return K(this,function c(){var d;return x(c,function(e){switch(e.f){case 1:if(!a.id){e.K(2);break}return w(e,Zi(a.id),3);case 3:(d=e.g)?a=d:Cf(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=U()-f)){e.K(4);break}Cf(Error("Networkless Logging: Stored logs request expired age limit"));if(!a.id){e.K(5);break}return w(e,aj(a.id),5);case 5:return e["return"]();case 4:f=a=tj(a);var g,h;if(null===(h=null===(g=null===f||void 0===f?void 0:f.options)||
void 0===g?void 0:g.C)||void 0===h?0:h.requestTimeMs)f.options.C.requestTimeMs=Math.round(U());(a=f)&&wh(a.url,a.options);e.f=0}})})}
function tj(a){var b=this,c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){return K(b,function h(){return x(h,function(k){if(1==k.f)return a&&a.id?a.sendCount<oj?w(k,$i(a.id),6):w(k,aj(a.id),2):k.K(2);2!=k.f&&ij(gj());c(e,f);k.f=0})})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){return K(b,function h(){return x(h,function(k){if(1==k.f)return a&&a.id?w(k,aj(a.id),2):k.K(2);d(e,f);k.f=0})})};
return a}
function rj(){return K(this,function b(){return x(b,function(c){return S("networkless_logging")?(2===Hf("networkless_ytidb_version")&&Ci().then(function(d){return d}),c["return"](Bi())):c["return"](!1)})})}
;function uj(a){var b=this;this.f=null;a?this.f=a:Dh()&&(this.f=Vg());gg(function(){Mh(b)},5E3)}
uj.prototype.isReady=function(){!this.f&&Dh()&&(this.f=Vg());return!!this.f};
function Yg(a,b,c,d){!Q("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&Cf(new Th("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new Th("innertube xhrclient not ready",b,c,d);R(e);e.sampleWeight=0;throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",C:c,Da:"JSON",V:function(){d.V()},
Ca:d.V,onSuccess:function(p,r){if(d.onSuccess)d.onSuccess(r)},
Ba:function(p){if(d.onSuccess)d.onSuccess(p)},
onError:function(p,r){if(d.onError)d.onError(r)},
Mb:function(p){if(d.onError)d.onError(p)},
timeout:d.timeout,withCredentials:!0},g="";(e=a.f.Va)&&(g=e);var h=a.f.Xa||!1,k=Eh(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.f.innertubeApiVersion+"/"+b;var l={alt:"json"};a.f.Wa&&f.headers.Authorization||(l.key=a.f.innertubeApiKey);var m=gh(""+g+e,l||{},!0);rj().then(function(p){if(d.retry&&S("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(S("networkless_gel")&&!p||!S("networkless_gel"))var r=Kh(b,
c,k,h);if(r){var t=f.onSuccess,A=f.Ba;f.onSuccess=function(D,X){Lh(r);t(D,X)};
c.Ba=function(D,X){Lh(r);A(D,X)}}}try{S("use_fetch_for_op_xhr")?th(m,f):S("networkless_gel")&&d.retry?(f.method="POST",qj(m,f)):(f.method="POST",f.C||(f.C={}),wh(m,f))}catch(D){if("InvalidAccessError"==D.name)r&&(Lh(r),r=0),Cf(Error("An extension is blocking network request."));
else throw D;}r&&gg(function(){Mh(a)},5E3)})}
;function vj(a,b,c){c=void 0===c?{}:c;var d=uj;Q("ytLoggingEventsDefaultDisabled",!1)&&uj==uj&&(d=null);$g(a,b,d,c)}
;var wj=[{za:function(a){return"Cannot read property '"+a.key+"'"},
...
groups:["key"]},{regexp:/\uac1c\uccb4\uac00 '([^']+)' \uc18d\uc131\uc774\ub098 \uba54\uc11c\ub4dc\ub97c \uc9c0\uc6d0\ud558\uc9c0 \uc54a\uc2b5\ub2c8\ub2e4./,groups:["key"]}]}}];function xj(){this.f=[];this.g=[]}
var yj;var zj=new O;var Aj=new Set,Bj=0,Cj=["PhantomJS","Googlebot","TO STOP THIS SECURITY SCAN go/scan"];function Dj(a){Ej(a,"WARNING")}
...
(window&&window.yterr||g)&&!(5<=Bj)&&0!==a.sampleWeight)){var h=yc(a);g=h.message||"Unknown Error";d=h.name||"UnknownError";e=h.lineNumber||"Not available";f=h.fileName||"Not available";h=h.stack||a.f||"Not available";if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var k=0,l=0;l<a.args.length;l++){var m=a.args[l],p="params."+l;k+=p.length;if(m)if(Array.isArray(m))for(var r=c,t=0;t<m.length&&!(m[t]&&(k+=Fj(t,m[t],p,r),500<k));t++);else if("object"===typeof m)for(r in r=void 0,t=c,m){if(m[r]&&
(k+=Fj(r,m[r],p,t),500<k))break}else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;else c[p]=String(JSON.stringify(m)).substring(0,500),k+=c[p].length;if(500<=k)break}else if(a.hasOwnProperty("params")&&a.params)if(m=a.params,"object"===typeof a.params)for(l in p=0,m){if(m[l]&&(k="params."+l,r=String(JSON.stringify(m[l])).substr(0,500),c[k]=r,p+=k.length+r.length,500<p))break}else c.params=String(JSON.stringify(m)).substr(0,500);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c.vendor=
navigator.vendor);c={message:g,name:d,lineNumber:e,fileName:f,stack:h,params:c};a=Number(a.columnNumber);isNaN(a)||(c.lineNumber=c.lineNumber+":"+a);a=u(wj);for(g=a.next();!g.done;g=a.next())if(g=g.value,g.sa[c.name])for(e=u(g.sa[c.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=c.message.match(f.regexp)){c.params["error.original"]=d[0];e=f.groups;f={};for(h=0;h<e.length;h++)f[e[h]]=d[h+1],c.params["error."+e[h]]=d[h+1];c.message=g.za(f);break}window.yterr&&"function"===typeof window.yterr&&window.yterr(c);
if(!(Aj.has(c.message)||0<=c.stack.indexOf("/YouTubeCenter.js")||0<=c.stack.indexOf("/mytube.js"))){zj.R("handleError",c);if(S("kevlar_gel_error_routing")){a=b;a:{g=u(Cj);for(d=g.next();!d.done;d=g.next())if(Sh(d.value.toLowerCase())){g=!0;break a}g=!1}if(!g){g={stackTrace:c.stack};c.fileName&&(g.filename=c.fileName);d=c.lineNumber&&c.lineNumber.split?c.lineNumber.split(":"):[];0!==d.length&&(1!==d.length||isNaN(Number(d[0]))?2!==d.length||isNaN(Number(d[0]))||isNaN(Number(d[1]))||(g.lineNumber=Number(d[0]),
g.columnNumber=Number(d[1])):g.lineNumber=Number(d[0]));d=c.message;e=c.name;yj||(yj=new xj);f=yj;a:{h=u(f.g);for(l=h.next();!l.done;l=h.next())if(l=l.value,c.message&&c.message.match(l.f)){f=l.weight;break a}f=u(f.f);for(h=f.next();!h.done;h=f.next())if(h=h.value,h.Ja(c)){f=h.weight;break a}f=1}d={level:"ERROR_LEVEL_UNKNOWN",message:d,errorClassName:e,sampleWeight:f};"ERROR"===a?d.level="ERROR_LEVEL_ERROR":"WARNING"===a&&(d.level="ERROR_LEVEL_WARNNING");a={isObfuscated:!0,browserStackInfo:g};g={pageUrl:window.location.href};
Q("FEXP_EXPERIMENTS")&&(g.experimentIds=Q("FEXP_EXPERIMENTS"));g.kvPairs=[];if(e=c.params)for(f=u(Object.keys(e)),h=f.next();!h.done;h=f.next())h=h.value,g.kvPairs.push({key:"client."+h,value:String(e[h])});e=Q("SERVER_NAME",void 0);f=Q("SERVER_VERSION",void 0);e&&f&&(g.kvPairs.push({key:"server.name",value:e}),g.kvPairs.push({key:"server.version",value:f}));vj("clientError",{errorMetadata:g,stackTrace:a,logMessage:d});Rg()}}a=c.params||{};b={rb:{a:"logerror",t:"jserror",type:c.name,msg:c.message.substr(0,
250),line:c.lineNumber,level:b,"client.name":a.name},C:{url:Q("PAGE_NAME",window.location.href),file:c.fileName},method:"POST"};a.version&&(b["client.version"]=a.version);if(b.C){c.stack&&(b.C.stack=c.stack);g=u(Object.keys(a));for(d=g.next();!d.done;d=g.next())d=d.value,b.C["client."+d]=a[d];if(a=Q("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(g=u(Object.keys(a)),d=g.next();!d.done;d=g.next())d=d.value,b.C[d]=a[d];a=Q("SERVER_NAME",void 0);g=Q("SERVER_VERSION",void 0);a&&g&&(b.C["server.name"]=
a,b.C["server.version"]=g)}wh(Q("ECATCHER_REPORT_HOST","")+"/error_204",b);Aj.add(c.message);Bj++}}}
function Fj(a,b,c,d){c+="."+a;a=String(JSON.stringify(b)).substr(0,500);d[c]=a;return c.length+a.length}
;function Gj(){this.g=!1;this.f=null}
Gj.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.g=!0,Zf(b,function(){g.g=!1;window.botguard?Hj(g,c,d,f):(dg(b),Dj(new Th("Unable to load Botguard","from "+b)))},e)):a&&(e=Lc(document,"SCRIPT"),e.textContent=a,e.nonce=Ea(),document.head.appendChild(e),document.head.removeChild(e),window.botguard?Hj(this,c,d,f):Dj(Error("Unable to load Botguard from JS")))};
function Hj(a,b,c,d){if(d)try{a.f=new window.botguard.bg(b,c?function(){return c(b)}:Ia)}catch(e){Dj(e)}else{try{a.f=new window.botguard.bg(b)}catch(e){Dj(e)}c&&c(b)}}
Gj.prototype.dispose=function(){this.f=null};var Ij=new Gj;function Jj(){return!!Ij.f}
function Kj(a){a=void 0===a?{}:a;a=void 0===a?{}:a;return Ij.f?Ij.f.invoke(void 0,void 0,a):null}
;var Lj=F().toString();
function Mj(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=F();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(Lj)for(a=1,b=0;b<Lj.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^Lj.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var Nj=y.ytLoggingDocDocumentNonce_||Mj();z("ytLoggingDocDocumentNonce_",Nj,void 0);var Oj=1;function Pj(a){this.f=a}
Pj.prototype.getAsJson=function(){var a={};void 0!==this.f.trackingParams?a.trackingParams=this.f.trackingParams:(a.veType=this.f.veType,void 0!==this.f.veCounter&&(a.veCounter=this.f.veCounter),void 0!==this.f.elementIndex&&(a.elementIndex=this.f.elementIndex));void 0!==this.f.dataElement&&(a.dataElement=this.f.dataElement.getAsJson());void 0!==this.f.youtubeData&&(a.youtubeData=this.f.youtubeData);return a};
Pj.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
Pj.prototype.isClientVe=function(){return!this.f.trackingParams&&!!this.f.veType};function Qj(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Rj(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Sj(a){return Q(Rj(void 0===a?0:a),void 0)}
z("yt_logging_screen.getRootVeType",Sj,void 0);function Tj(){var a=Sj(0),b;a?b=new Pj({veType:a,youtubeData:void 0}):b=null;return b}
function Uj(){var a=Q("csn-to-ctt-auth-info");a||(a={},P("csn-to-ctt-auth-info",a));return a}
function Vj(a){a=void 0===a?0:a;var b=Q(Qj(a));if(!b&&!Q("USE_CSN_FALLBACK",!0))return null;b||0!=a||(S("kevlar_client_side_screens")||S("c3_client_side_screens")?b="UNDEFINED_CSN":b=Q("EVENT_ID"));return b?b:null}
z("yt_logging_screen.getCurrentCsn",Vj,void 0);function Wj(a,b,c){var d=Uj();(c=Vj(c))&&delete d[c];b&&(d[a]=b)}
function Xj(a){return Uj()[a]}
z("yt_logging_screen.getCttAuthInfo",Xj,void 0);function Yj(a,b,c,d){c=void 0===c?0:c;if(a!==Q(Qj(c))||b!==Q(Rj(c)))if(Wj(a,d,c),P(Qj(c),a),P(Rj(c),b),0==c||S("web_screen_associated_all_layers"))b=function(){setTimeout(function(){a&&$g("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:Nj,clientScreenNonce:a},uj)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
z("yt_logging_screen.setCurrentScreen",Yj,void 0);function Zj(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=Q("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=Q("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Yb(window.location.href);g&&f.push(g);g=Yb(d);if(0<=Xa(f,g)||!g&&0==d.lastIndexOf("/",0))if(S("autoescape_tempdata_url")&&(f=document.createElement("a"),Sb(f,d),d=f.href),d){g=d.match(Wb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:Vj()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Vb(d).toString(36),e=e?$b(e):"",Ff(b,e,k||5))}else k=b,e="ST-"+Vb(d).toString(36),k=k?$b(k):"",Ff(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var m=void 0===m?"":m;var p=void 0===p?window:p;c=p.location;a=ac(a,l)+m;a=a instanceof I?a:Kb(a);c.href=Gb(a)}return!0}
;function ak(a,b){this.version=a;this.args=b}
;function bk(a,b){this.topic=a;this.f=b}
bk.prototype.toString=function(){return this.topic};var ck=B("ytPubsub2Pubsub2Instance")||new O;O.prototype.subscribe=O.prototype.subscribe;O.prototype.unsubscribeByKey=O.prototype.U;O.prototype.publish=O.prototype.R;O.prototype.clear=O.prototype.clear;z("ytPubsub2Pubsub2Instance",ck,void 0);var dk=B("ytPubsub2Pubsub2SubscribedKeys")||{};z("ytPubsub2Pubsub2SubscribedKeys",dk,void 0);var ek=B("ytPubsub2Pubsub2TopicToKeys")||{};z("ytPubsub2Pubsub2TopicToKeys",ek,void 0);var fk=B("ytPubsub2Pubsub2IsAsync")||{};z("ytPubsub2Pubsub2IsAsync",fk,void 0);
z("ytPubsub2Pubsub2SkipSubKey",null,void 0);function gk(a,b){var c=hk();c&&c.publish.call(c,a.toString(),a,b)}
function ik(a){var b=jk,c=hk();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=B("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(dk[d])try{if(f&&b instanceof bk&&b!=e)try{var h=b.f,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.L){var l=new h;h.L=l.version}var m=h.L}catch(p){}if(!m||k.version!=m)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
db(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){R(p)}},fk[b.toString()]?B("yt.scheduler.instance")?ig(g):T(g,0):g())});
dk[d]=!0;ek[b.toString()]||(ek[b.toString()]=[]);ek[b.toString()].push(d);return d}
function kk(){var a=lk,b=ik(function(c){a.apply(void 0,arguments);mk(b)});
return b}
function mk(a){var b=hk();b&&("number"===typeof a&&(a=[a]),H(a,function(c){b.unsubscribeByKey(c);delete dk[c]}))}
function hk(){return B("ytPubsub2Pubsub2Instance")}
;function nk(a){ak.call(this,1,arguments);this.csn=a}
v(nk,ak);var jk=new bk("screen-created",nk),ok=[],pk=0;function qk(a,b,c){var d=S("use_default_events_client")?void 0:uj;b={csn:a,parentVe:b.getAsJson(),childVes:Za(c,function(f){return f.getAsJson()})};
c=u(c);for(var e=c.next();!e.done;e=c.next())e=e.value.getAsJson(),(jb(e)||!e.trackingParams&&!e.veType)&&Dj(Error("Child VE logged with no data"));c={ja:Xj(a),W:a};"UNDEFINED_CSN"==a?rk("visualElementAttached",b,c):d?$g("visualElementAttached",b,d,c):vj("visualElementAttached",b,c)}
function rk(a,b,c){ok.push({payloadName:a,payload:b,options:c});pk||(pk=kk())}
function lk(a){if(ok){for(var b=u(ok),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,$g(c.payloadName,c.payload,null,c.options));ok.length=0}pk=0}
;function sk(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
sk.prototype.clone=function(){var a=new sk,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==Ka(c)?a[b]=mb(c):a[b]=c}return a};function tk(){M.call(this);this.f=[]}
v(tk,M);tk.prototype.o=function(){for(;this.f.length;){var a=this.f.pop();a.target.removeEventListener(a.name,a.Ja)}M.prototype.o.call(this)};var uk=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function vk(a){a=a||"";if(window.spf){var b=a.match(uk);spf.style.load(a,b?b[1]:"",void 0)}else wk(a)}
function wk(a){var b=xk(a),c=document.getElementById(b),d=c&&Kf(c,"loaded");d||c&&!d||(c=yk(a,b,function(){Kf(c,"loaded")||(If(c),Uf(b),T(Ra(Vf,b),0))}))}
function yk(a,b,c){var d=document.createElement("link");d.id=b;d.onload=function(){c&&setTimeout(c,0)};
a=Zc(a);d.rel="stylesheet";d.href=ub(a).toString();(document.getElementsByTagName("head")[0]||document.body).appendChild(d);return d}
function xk(a){var b=Lc(document,"A");Sb(b,new I(a,Fb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Vb(a)}
;function zk(a,b,c,d){M.call(this);var e=this;this.m=this.ba=a;this.G=b;this.u=!1;this.api={};this.Z=this.F=null;this.H=new O;Tc(this,Ra(Uc,this.H));this.j={};this.O=this.aa=this.i=this.ia=this.f=null;this.N=!1;this.l=this.D=null;this.ca={};this.Ga=["onReady"];this.ha=null;this.ta=NaN;this.X={};this.h=d;Ak(this);this.da("WATCH_LATER_VIDEO_ADDED",this.ab.bind(this));this.da("WATCH_LATER_VIDEO_REMOVED",this.bb.bind(this));this.da("onAdAnnounce",this.Ia.bind(this));this.Ha=new tk(this);Tc(this,Ra(Uc,
this.Ha));this.Y=0;c?this.Y=T(function(){e.loadNewVideoConfig(c)},0):d&&(Bk(this),Ck(this))}
v(zk,M);n=zk.prototype;n.getId=function(){return this.G};
n.loadNewVideoConfig=function(a){if(!this.g){this.Y&&(Mf(this.Y),this.Y=0);a instanceof sk||(a=new sk(a));this.ia=a;this.f=a.clone();Bk(this);this.aa||(this.aa=Dk(this,this.f.args.jsapicallback||"onYouTubePlayerReady"));this.f.args.jsapicallback=null;if(a=this.f.attrs.width)this.m.style.width=ad(Number(a)||String(a));if(a=this.f.attrs.height)this.m.style.height=ad(Number(a)||String(a));Ck(this);this.u&&Ek(this)}};
function Bk(a){var b;a.h?b=a.h.rootElementId:b=a.f.attrs.id;a.i=b||a.i;"video-player"==a.i&&(a.i=a.G,a.h?a.h.rootElementId=a.G:a.f.attrs.id=a.G);a.m.id==a.i&&(a.i+="-player",a.h?a.h.rootElementId=a.i:a.f.attrs.id=a.i)}
n.Na=function(){return this.ia};
function Ek(a){a.f&&!a.f.loaded&&(a.f.loaded=!0,"0"!=a.f.args.autoplay?a.api.loadVideoByPlayerVars(a.f.args):a.api.cueVideoByPlayerVars(a.f.args))}
function Fk(a){var b=!0,c=Gk(a);c&&a.f&&(a=Hk(a),b=Kf(c,"version")===a);return b&&!!B("yt.player.Application.create")}
function Ck(a){if(!a.g&&!a.N){var b=Fk(a);if(b&&"html5"==(Gk(a)?"html5":null))a.O="html5",a.u||Ik(a);else if(Jk(a),a.O="html5",b&&a.l)a.ba.appendChild(a.l),Ik(a);else{a.f&&(a.f.loaded=!0);var c=!1;a.D=function(){c=!0;var d=Kk(a,"player_bootstrap_method")?B("yt.player.Application.createAlternate")||B("yt.player.Application.create"):B("yt.player.Application.create");var e=a.f?a.f.clone():void 0;d(a.ba,e,a.h);Ik(a)};
a.N=!0;b?a.D():(Zf(Hk(a),a.D),(b=a.h?a.h.cssUrl:a.f.assets.css)&&vk(b),Lk(a)&&!c&&z("yt.player.Application.create",null,void 0))}}}
function Gk(a){var b=Hc(a.i);!b&&a.m&&a.m.querySelector&&(b=a.m.querySelector("#"+a.i));return b}
function Ik(a){if(!a.g){var b=Gk(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.N=!1,!Kk(a,"html5_remove_not_servable_check_killswitch")&&b.isNotServable&&a.f&&b.isNotServable(a.f.args.video_id)||Mk(a)):a.ta=T(function(){Ik(a)},50)}}
function Mk(a){Ak(a);a.u=!0;var b=Gk(a);b.addEventListener&&(a.F=Nk(a,b,"addEventListener"));b.removeEventListener&&(a.Z=Nk(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=Nk(a,b,e))}for(var f in a.j)a.F(f,a.j[f]);Ek(a);a.aa&&a.aa(a.api);a.H.R("onReady",a.api)}
function Nk(a,b,c){var d=b[c];return function(){try{return a.ha=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ha=e,Cf(e))}}}
function Ak(a){a.u=!1;if(a.Z)for(var b in a.j)a.Z(b,a.j[b]);for(var c in a.X)Mf(parseInt(c,10));a.X={};a.F=null;a.Z=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.da.bind(a);a.api.removeEventListener=a.gb.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Oa.bind(a);a.api.getPlayerType=a.Pa.bind(a);a.api.getCurrentVideoConfig=a.Na.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Ya.bind(a)}
n.Ya=function(){return this.u};
n.da=function(a,b){var c=this,d=Dk(this,b);if(d){if(!(0<=Xa(this.Ga,a)||this.j[a])){var e=Ok(this,a);this.F&&this.F(a,e)}this.H.subscribe(a,d);"onReady"==a&&this.u&&T(function(){d(c.api)},0)}};
n.gb=function(a,b){if(!this.g){var c=Dk(this,b);c&&ef(this.H,a,c)}};
function Dk(a,b){var c=b;if("string"==typeof b){if(a.ca[b])return a.ca[b];c=function(){var d=B(b);d&&d.apply(y,arguments)};
a.ca[b]=c}return c?c:null}
function Ok(a,b){var c="ytPlayer"+b+a.G;a.j[b]=c;y[c]=function(d){var e=T(function(){if(!a.g){a.H.R(b,d);var f=a.X,g=String(e);g in f&&delete f[g]}},0);
kb(a.X,String(e))};
return c}
n.Ia=function(a){Uf("a11y-announce",a)};
n.ab=function(a){Uf("WATCH_LATER_VIDEO_ADDED",a)};
n.bb=function(a){Uf("WATCH_LATER_VIDEO_REMOVED",a)};
n.Pa=function(){return this.O||(Gk(this)?"html5":null)};
n.Oa=function(){return this.ha};
function Jk(a){a.cancel();Ak(a);a.O=null;a.f&&(a.f.loaded=!1);var b=Gk(a);b&&(Fk(a)||!Lk(a)?a.l=b:(b&&b.destroy&&b.destroy(),a.l=null));for(a=a.ba;b=a.firstChild;)a.removeChild(b)}
n.cancel=function(){if(this.D){var a=Hk(this);eg(a,this.D)}Mf(this.ta);this.N=!1};
n.o=function(){Jk(this);if(this.l&&this.f&&this.l.destroy)try{this.l.destroy()}catch(b){R(b)}this.ca=null;for(var a in this.j)y[this.j[a]]=null;this.ia=this.f=this.api=null;delete this.ba;delete this.m;M.prototype.o.call(this)};
function Lk(a){return a.f&&a.f.args&&a.f.args.fflags?-1!=a.f.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Hk(a){return a.h?a.h.jsUrl:a.f.assets.js}
function Kk(a,b){if(a.h)var c=a.h.serializedExperimentFlags;else a.f&&a.f.args&&(c=a.f.args.fflags);return"true"==dh(c||"")[b]}
;var Pk={},Qk="player_uid_"+(1E9*Math.random()>>>0);
function Rk(a,b,c){var d="player";c=void 0===c?!0:c;var e;"string"===typeof d?e=Hc(d):e=d;d=e;e=Qk+"_"+Ma(d);var f=Pk[e];if(f&&c)return(b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags&&a.args.fflags.includes("web_player_remove_playerproxy=true"))?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new zk(d,e,a,b);Pk[e]=f;Uf("player-added",f.api);Tc(f,Ra(Sk,f));return f.api}
function Sk(a){delete Pk[a.getId()]}
;function Tk(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
;function Xk(a){a=void 0===a?!1:a;M.call(this);this.f=new O(a);Tc(this,Ra(Uc,this.f))}
G(Xk,M);Xk.prototype.subscribe=function(a,b,c){return this.g?0:this.f.subscribe(a,b,c)};
Xk.prototype.j=function(a,b){this.g||this.f.R.apply(this.f,arguments)};function Yk(a,b,c){Xk.call(this);this.h=a;this.i=b;this.l=c}
v(Yk,Xk);function Zk(a,b,c){if(!a.g){var d=a.h;d.g||a.i!=d.f||(a={id:a.l,command:b},c&&(a.data=c),d.f.postMessage(De(a),d.i))}}
Yk.prototype.o=function(){this.i=this.h=null;Xk.prototype.o.call(this)};function $k(a){M.call(this);this.f=a;this.f.subscribe("command",this.Ea,this);this.h={};this.j=!1}
v($k,M);n=$k.prototype;n.start=function(){this.j||this.g||(this.j=!0,Zk(this.f,"RECEIVING"))};
n.Ea=function(a,b,c){if(this.j&&!this.g){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.h||(c=E(this.ib,this,a),this.h[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&al(this,d.event);break;default:this.i.isReady()&&this.i.isExternalMethodAvailable(a,c||null)&&(b=bl(a,b||{}),c=this.i.handleExternalCall(a,b,c||null),(c=cl(a,c))&&this.j&&!this.g&&Zk(this.f,a,c))}}};
n.ib=function(a,b){this.j&&!this.g&&Zk(this.f,a,this.la(a,b))};
n.la=function(a,b){if(null!=b)return{value:b}};
function al(a,b){b in a.h&&(a.removeEventListener(b,a.h[b]),delete a.h[b])}
n.o=function(){var a=this.f;a.g||ef(a.f,"command",this.Ea,this);this.f=null;for(var b in this.h)al(this,b);M.prototype.o.call(this)};function dl(a,b){$k.call(this,b);this.i=a;this.start()}
v(dl,$k);dl.prototype.addEventListener=function(a,b){this.i.addEventListener(a,b)};
dl.prototype.removeEventListener=function(a,b){this.i.removeEventListener(a,b)};
function bl(a,b){switch(a){case "loadVideoById":return b=Vk(b),[b];case "cueVideoById":return b=Vk(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=Wk(b),[b];case "cuePlaylist":return b=Wk(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
dl.prototype.la=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return $k.prototype.la.call(this,a,b)};
dl.prototype.o=function(){$k.prototype.o.call(this);delete this.i};function el(a,b,c){M.call(this);var d=this;c=c||Q("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.h=b||null;this.u="*";this.i=c;this.sessionId=null;this.channel="widget";this.D=!!a;this.m=function(e){a:if(!("*"!=d.i&&e.origin!=d.i||d.h&&e.source!=d.h||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.D&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(el,M);el.prototype.sendMessage=function(a,b){var c=b||this.h;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.u)}catch(e){Cf(e)}}};
el.prototype.o=function(){window.removeEventListener("message",this.m);M.prototype.o.call(this)};function fl(){var a=this.g=new el(!!Q("WIDGET_ID_ENFORCE")),b=E(this.fb,this);a.j=b;a.l=null;this.g.channel="widget";if(a=Q("WIDGET_ID"))this.g.sessionId=a;this.i=[];this.l=!1;this.j={}}
n=fl.prototype;n.fb=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.j[a]||"onReady"==a||(this.addEventListener(a,gl(this,a)),this.j[a]=!0)):this.Aa(a,b,c)};
n.Aa=function(){};
function gl(a,b){return E(function(c){this.sendMessage(b,c)},a)}
n.addEventListener=function(){};
n.Ma=function(){this.l=!0;this.sendMessage("initialDelivery",this.ma());this.sendMessage("onReady");H(this.i,this.Fa,this);this.i=[]};
n.ma=function(){return null};
function hl(a,b){a.sendMessage("infoDelivery",b)}
n.Fa=function(a){this.l?this.g.sendMessage(a):this.i.push(a)};
n.sendMessage=function(a,b){this.Fa({event:a,info:void 0==b?null:b})};
n.dispose=function(){this.g=null};function il(a){fl.call(this);this.f=a;this.h=[];this.addEventListener("onReady",E(this.cb,this));this.addEventListener("onVideoProgress",E(this.mb,this));this.addEventListener("onVolumeChange",E(this.nb,this));this.addEventListener("onApiChange",E(this.hb,this));this.addEventListener("onPlaybackQualityChange",E(this.jb,this));this.addEventListener("onPlaybackRateChange",E(this.kb,this));this.addEventListener("onStateChange",E(this.lb,this));this.addEventListener("onWebglSettingsChanged",E(this.ob,
this))}
v(il,fl);n=il.prototype;n.Aa=function(a,b,c){if(this.f.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Tk(a)){var d=b;if(C(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Vk.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Uk.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Wk.apply(window,d)}d=e}b.length=1;b[0]=d}this.f.handleExternalCall(a,b,c);Tk(a)&&hl(this,this.ma())}};
n.cb=function(){var a=E(this.Ma,this);this.g.f=a};
...
this.f.getVideoUrl());this.f.getVideoContentRect&&(a.videoContentRect=this.f.getVideoContentRect());this.f.getProgressState&&(a.progressState=this.f.getProgressState());this.f.getPlaylist&&(a.playlist=this.f.getPlaylist());this.f.getPlaylistIndex&&(a.playlistIndex=this.f.getPlaylistIndex());this.f.getStoryboardFormat&&(a.storyboardFormat=this.f.getStoryboardFormat());hl(this,a)};
n.jb=function(a){hl(this,{playbackQuality:a})};
n.kb=function(a){hl(this,{playbackRate:a})};
...
n.nb=function(){hl(this,{muted:this.f.isMuted(),volume:this.f.getVolume()})};
n.mb=function(a){a={currentTime:a,videoBytesLoaded:this.f.getVideoBytesLoaded(),videoLoadedFraction:this.f.getVideoLoadedFraction(),currentTimeLastUpdated_:F()/1E3,playbackRate:this.f.getPlaybackRate(),mediaReferenceTime:this.f.getMediaReferenceTime()};this.f.getProgressState&&(a.progressState=this.f.getProgressState());hl(this,a)};
n.ob=function(){var a={sphericalProperties:this.f.getSphericalProperties()};hl(this,a)};
n.dispose=function(){fl.prototype.dispose.call(this);for(var a=0;a<this.h.length;a++){var b=this.h[a];this.f.removeEventListener(b.eventType,b.listener)}this.h=[]};function jl(a,b,c){M.call(this);this.f=a;this.i=c;this.j=wg(window,"message",E(this.l,this));this.h=new Yk(this,a,b);Tc(this,Ra(Uc,this.h))}
v(jl,M);jl.prototype.l=function(a){var b;if(b=!this.g)if(b=a.origin==this.i)a:{b=this.f;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.h,c.g||c.j("command",b.command,b.data,a.origin))}};
jl.prototype.o=function(){xg(this.j);this.f=null;M.prototype.o.call(this)};function kl(){var a=mb(ll),b;return Ue(new N(function(c,d){a.onSuccess=function(e){nh(e)?c(e):d(new ml("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
a.onError=function(e){d(new ml("Unknown request error","net.unknown",e))};
a.V=function(e){d(new ml("Request timed out","net.timeout",e))};
b=wh("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Ve&&b.abort();
return Pe(c)})}
function ml(a,b,c){Ua.call(this,a+", errorCode="+b);this.errorCode=b;this.xhr=c;this.name="PromiseAjaxError"}
v(ml,Ua);function nl(){this.g=0;this.f=null}
nl.prototype.then=function(a,b,c){return 1===this.g&&a?(a=a.call(c,this.f),Je(a)?a:ol(a)):2===this.g&&b?(a=b.call(c,this.f),Je(a)?a:pl(a)):this};
nl.prototype.getValue=function(){return this.f};
nl.prototype.$goog_Thenable=!0;function pl(a){var b=new nl;a=void 0===a?null:a;b.g=2;b.f=void 0===a?null:a;return b}
function ol(a){var b=new nl;a=void 0===a?null:a;b.g=1;b.f=void 0===a?null:a;return b}
;function ql(a){Ua.call(this,a.message||a.description||a.name);this.isMissing=a instanceof rl;this.isTimeout=a instanceof ml&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Ve}
v(ql,Ua);ql.prototype.name="BiscottiError";function rl(){Ua.call(this,"Biscotti ID is missing from server")}
v(rl,Ua);rl.prototype.name="BiscottiMissingError";var ll={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},sl=null;
function bh(){if(S("disable_biscotti_fetch_on_html5_clients"))return Pe(Error("Fetching biscotti ID is disabled."));if(S("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!Dc.get("CONSENT","").startsWith("YES+"))return Pe(Error("User has not consented - not fetching biscotti id."));if("1"===gb(yf(),"args","privembed"))return Pe(Error("Biscotti ID is not available in private embed mode"));sl||(sl=Ue(kl().then(tl),function(a){return ul(2,a)}));
return sl}
function tl(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new rl;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new rl;a=a.id;ch(a);sl=ol(a);vl(18E5,2);return a}
function ul(a,b){var c=new ql(b);ch("");sl=pl(c);0<a&&vl(12E4,a-1);throw c;}
function vl(a,b){T(function(){Ue(kl().then(tl,function(c){return ul(b,c)}),Ia)},a)}
function wl(){try{var a=B("yt.ads.biscotti.getId_");return a?a():bh()}catch(b){return Pe(b)}}
;function xl(a){if("1"!==gb(yf(),"args","privembed")){a&&ah();try{wl().then(function(){},function(){}),T(xl,18E5)}catch(b){R(b)}}}
;var Y=B("ytglobal.prefsUserPrefsPrefs_")||{};z("ytglobal.prefsUserPrefsPrefs_",Y,void 0);function yl(){this.f=Q("ALT_PREF_COOKIE_NAME","PREF");var a=Dc.get(""+this.f,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(Y[d]=c.toString())}}}
n=yl.prototype;n.get=function(a,b){zl(a);Al(a);var c=void 0!==Y[a]?Y[a].toString():null;return null!=c?c:b?b:""};
n.set=function(a,b){zl(a);Al(a);if(null==b)throw Error("ExpectedNotNull");Y[a]=b.toString()};
n.remove=function(a){zl(a);Al(a);delete Y[a]};
...
function Bl(a){a=void 0!==Y[a]?Y[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Ja(yl);function Cl(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Dl(a)||c.some(function(e){return!Dl(e)}))throw Error("Only objects may be merged.");
c=u(c);for(d=c.next();!d.done;d=c.next())El(a,d.value);return a}
function El(a,b){for(var c in b)if(Dl(b[c])){if(c in a&&!Dl(a[c]))throw Error("Cannot merge an object into a non-object.");c in a||(a[c]={});El(a[c],b[c])}else if(Fl(b[c])){if(c in a&&!Fl(a[c]))throw Error("Cannot merge an array into a non-array.");c in a||(a[c]=[]);Gl(a[c],b[c])}else a[c]=b[c];return a}
function Gl(a,b){for(var c=u(b),d=c.next();!d.done;d=c.next())d=d.value,Dl(d)?a.push(El({},d)):Fl(d)?a.push(Gl([],d)):a.push(d);return a}
...
c))&&c<l;){var m=a.charCodeAt(c-1);if(38==m||63==m){var p=a.charCodeAt(c+2);if(!p||61==p||38==p||35==p){var r=c;break d}}c+=3}r=-1}if(0>r)var t=null;else{var A=a.indexOf("&",r);if(0>A||A>l)A=l;r+=3;t=decodeURIComponent(a.substr(r,A-r).replace(/\+/g," "))}k="1"!==t}f=!k;break b}}catch(D){}f=!1}f?Kl(a)?(b&&b(),f=!0):f=!1:f=!1;f||Ll(a,b)}}
function Kl(a,b){try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,void 0===b?"":b))return!0}catch(c){}return!1}
function Ll(a,b){var c=new Image,d=""+Il++;Hl[d]=c;c.onload=c.onerror=function(){b&&Hl[d]&&b();delete Hl[d]};
c.src=a}
;function Ml(a,b){ak.call(this,1,arguments)}
v(Ml,ak);function Nl(a,b){ak.call(this,1,arguments)}
v(Nl,ak);var Ol=new bk("aft-recorded",Ml),Pl=new bk("timing-sent",Nl);var Ql=window;function Rl(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var Sl=Ql.performance||Ql.mozPerformance||Ql.msPerformance||Ql.webkitPerformance||new Rl;var Tl=!1;E(Sl.clearResourceTimings||Sl.webkitClearResourceTimings||Sl.mozClearResourceTimings||Sl.msClearResourceTimings||Sl.oClearResourceTimings||Ia,Sl);function Ul(a){var b=Vl(a);if(b.aft)return b.aft;a=Q((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function Wl(a){var b;(b=B("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Sa("ytcsi."+(a||"")+"data_",b));return b}
function Xl(a){a=Wl(a);a.info||(a.info={});return a.info}
function Vl(a){a=Wl(a);a.tick||(a.tick={});return a.tick}
function Yl(a){var b=Wl(a).nonce;b||(b=Mj(),Wl(a).nonce=b);return b}
function Zl(a){var b=Vl(a||""),c=Ul(a);c&&!Tl&&(gk(Ol,new Ml(Math.round(c-b._start),a)),Tl=!0)}
;function $l(){var a=B("ytcsi.debug");a||(a=[],z("ytcsi.debug",a,void 0),z("ytcsi.reference",{},void 0));return a}
function am(a){a=a||"";var b=B("ytcsi.reference");b||($l(),b=B("ytcsi.reference"));if(b[a])return b[a];var c=$l(),d={timerName:a,info:{},tick:{},span:{}};c.push(d);return b[a]=d}
;var bm=y.ytLoggingLatencyUsageStats_||{};z("ytLoggingLatencyUsageStats_",bm,void 0);function cm(){this.f=0}
function dm(){cm.f||(cm.f=new cm);return cm.f}
cm.prototype.tick=function(a,b,c){em(this,"tick_"+a+"_"+b)||vj("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
cm.prototype.info=function(a,b){var c=Object.keys(a).join("");em(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,vj("latencyActionInfo",c))};
cm.prototype.span=function(a,b){var c=Object.keys(a).join("");em(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,vj("latencyActionSpan",a))};
function em(a,b){bm[b]=bm[b]||{count:0};var c=bm[b];c.count++;c.time=U();a.f||(a.f=gg(function(){var d=U(),e;for(e in bm)bm[e]&&6E4<d-bm[e].time&&delete bm[e];a&&(a.f=0)},5E3));
return 5<c.count?(6===c.count&&1>1E5*Math.random()&&(c=new Th("CSI data exceeded logging limit with key",b.split("_")),0<=b.indexOf("plev")||Dj(c)),!0):!1}
;var Z={},fm=(Z.ad_allowed="adTypesAllowed",Z.yt_abt="adBreakType",Z.ad_cpn="adClientPlaybackNonce",Z.ad_docid="adVideoId",Z.yt_ad_an="adNetworks",Z.ad_at="adType",Z.aida="appInstallDataAgeMs",Z.browse_id="browseId",Z.p="httpProtocol",Z.t="transportProtocol",Z.cpn="clientPlaybackNonce",Z.ccs="creatorInfo.creatorCanaryState",Z.cseg="creatorInfo.creatorSegment",Z.csn="clientScreenNonce",Z.docid="videoId",Z.GetHome_rid="requestIds",Z.GetSearch_rid="requestIds",Z.GetPlayer_rid="requestIds",Z.GetWatchNext_rid=
...
Z.rcl="mwebInfo.responseContentLength",Z.GetSettings_rid="requestIds",Z.GetTrending_rid="requestIds",Z.GetMusicSearchSuggestions_rid="requestIds",Z.REQUEST_ID="requestIds",Z),gm="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),
hm={},im=(hm.ccs="CANARY_STATE_",hm.mver="MEASUREMENT_VERSION_",hm.pis="PLAYER_INITIALIZED_STATE_",hm.yt_pt="LATENCY_PLAYER_",hm.pa="LATENCY_ACTION_",hm.yt_vst="VIDEO_STREAM_TYPE_",hm),jm="all_vc ap c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function km(a){return!!Q("FORCE_CSI_ON_GEL",!1)||S("csi_on_gel")||!!Wl(a).useGel}
function lm(a){a=Wl(a);if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
;function mm(a,b,c){if(null!==b)if(Xl(c)[a]=b,km(c)){var d=b;b=lm(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in fm){b=fm[a];0<=Xa(gm,b)&&(d=!!d);a in im&&"string"===typeof d&&(d=im[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Cl({},e)}else 0<=Xa(jm,a)||Dj(new Th("Unknown label logged with GEL CSI",
a)),f=void 0;f&&km(c)&&(b=am(c||""),Cl(b.info,f),b=lm(c),"gelInfos"in b||(b.gelInfos={}),Cl(b.gelInfos,f),c=Yl(c),dm().info(f,c))}else am(c||"").info[a]=b}
function nm(a,b,c){var d=Vl(c);if(S("use_first_tick")&&om(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;Sl.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),Sl.mark(e))}e=b||U();d[a]=e;e=lm(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||U();if(km(c)){am(c||"").tick[a]=b||U();e=Yl(c);if("_start"===a){var f=dm();em(f,"baseline_"+e)||vj("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else dm().tick(a,e,b);Zl(c);e=!0}else e=!1;if(!e){if(!B("yt.timing."+(c||"")+"pingSent_")&&
(f=Q((c||"")+"TIMING_ACTION",void 0),e=Vl(c),B("ytglobal.timing"+(c||"")+"ready_")&&f&&om("_start")&&Ul(c)))if(Zl(c),c)pm(c);else{f=!0;var g=Q("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&pm(c)}am(c||"").tick[a]=b||U()}return d[a]}
function om(a,b){var c=Vl(b);return a in c}
function pm(a){if(!km(a)){var b=Vl(a),c=Xl(a),d=b._start,e=Q("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:Q((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=Ul(a);var h=Vl(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&Xl(a).yt_pvis&&"youtube"===e&&(mm("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var m in c)"_"!==m.charAt(0)&&(f[m]=c[m]);b.ps=U();m={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),m[p]=k,e.push(p+"."+k));f.rt=
e.join(",");b=!!c.ap;S("debug_csi_data")&&(c=B("yt.timing.csiData"),c||(c=[],Sa("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var r in f)f.hasOwnProperty(r)&&(c+="&"+r+"="+f[r]);f="/csi_204?"+c.substring(1);if(window.navigator&&window.navigator.sendBeacon&&b){var t=void 0===t?"":t;Kl(f,t)||Jl(f,void 0,void 0,void 0,t)}else Jl(f);z("yt.timing."+(a||"")+"pingSent_",!0,void 0);gk(Pl,new Nl(m.aft+(Number(g)||0),a))}}
var qm=window;qm.ytcsi&&(qm.ytcsi.info=mm,qm.ytcsi.tick=nm);var rm=null,sm=null,tm=null,um={};function vm(a){var b=a.id;a=a.ve_type;var c=Oj++;a=new Pj({veType:a,veCounter:c,elementIndex:void 0,dataElement:void 0,youtubeData:void 0});um[b]=a;b=Vj();c=Tj();b&&c&&qk(b,c,[a])}
function wm(){var a=rm.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
function xm(a){var b=a.csn;a=a.root_ve_type;if(b&&a&&(Yj(b,a),a=Tj()))for(var c in um){var d=um[c];d&&qk(b,a,[d])}}
function ym(a){um[a.id]=new Pj({trackingParams:a.tracking_params})}
function zm(a){var b=Vj(),c=um[a.id];if(b&&c){a=S("use_default_events_client")?void 0:uj;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";c={csn:b,ve:c.getAsJson(),gestureType:d};d={ja:Xj(b),W:b};"UNDEFINED_CSN"==b?rk("visualElementGestured",c,d):a?$g("visualElementGestured",c,a,d):vj("visualElementGestured",c,d)}}
function Am(a){a=a.ids;var b=Vj();if(b)for(var c=0;c<a.length;c++){var d=um[a[c]];if(d){var e=b,f=S("use_default_events_client")?void 0:uj;d={csn:e,ve:d.getAsJson(),eventType:1};var g={ja:Xj(e),W:e};"UNDEFINED_CSN"==e?rk("visualElementShown",d,g):f?$g("visualElementShown",d,f,g):vj("visualElementShown",d,g)}}}
;z("yt.setConfig",P,void 0);z("yt.config.set",P,void 0);z("yt.setMsg",Ef,void 0);z("yt.msgs.set",Ef,void 0);z("yt.logging.errors.log",Ej,void 0);
z("writeEmbed",function(){var a=Q("PLAYER_CONFIG",void 0);if(!a){var b=Q("PLAYER_VARS",void 0);b&&(a={args:b})}xl(!0);"gvn"==a.args.ps&&(document.body.style.backgroundColor="transparent");a.args.forced_experiments||(b=window.location.href,-1!=b.indexOf("?")?(b=(b||"").split("#")[0],b=b.split("?",2),b=fh(1<b.length?b[1]:b[0])):b={},b.forced_experiments&&(a.args.forced_experiments=b.forced_experiments));a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=Q("POST_MESSAGE_ORIGIN");
window!=window.top&&c&&c!=document.URL&&(a.args.loaderUrl=c);rm=a=(c=Q("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c?Rk(a,c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER,!1):Rk(a);a.addEventListener("onScreenChanged",xm);a.addEventListener("onLogClientVeCreated",vm);a.addEventListener("onLogServerVeCreated",ym);a.addEventListener("onLogVeClicked",zm);a.addEventListener("onLogVesShown",Am);a.addEventListener("onVideoDataChange",wm);c=Q("POST_MESSAGE_ID","player");
Q("ENABLE_JS_API")?tm=new il(a):Q("ENABLE_POST_API")&&"string"===typeof c&&"string"===typeof b&&(sm=new jl(window.parent,c,b),tm=new dl(a,sm.h));ng()},void 0);
var Bm=Bf(function(){nm("ol");var a=yl.getInstance(),b=!!((Bl("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Md(document.body,"exp-invert-logo"))if(c&&!Md(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Md(d,"inverted-hdpi")){var e=Kd(d);Ld(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Md(document.body,"inverted-hdpi")&&Nd();b!=c&&(b="f"+(Math.floor(119/31)+1),d=Bl(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete Y[b]:(c=d.toString(16),Y[b]=c.toString()),a.save())}),Cm=Bf(function(){var a=rm;
a&&a.sendAbandonmentPing&&a.sendAbandonmentPing();Q("PL_ATT")&&Ij.dispose();a=0;for(var b=lg.length;a<b;a++)kg(lg[a]);lg.length=0;dg("//static.doubleclick.net/instream/ad_status.js");mg=!1;P("DCLKSTAT",0);Vc(tm,sm);if(a=rm)a.removeEventListener("onScreenChanged",xm),a.removeEventListener("onLogClientVeCreated",vm),a.removeEventListener("onLogServerVeCreated",ym),a.removeEventListener("onLogVeClicked",zm),a.removeEventListener("onLogVesShown",Am),a.removeEventListener("onVideoDataChange",wm),a.destroy();
um={}});
window.addEventListener?(window.addEventListener("load",Bm),window.addEventListener("unload",Cm)):window.attachEvent&&(window.attachEvent("onload",Bm),window.attachEvent("onunload",Cm));Sa("yt.abuse.player.botguardInitialized",B("yt.abuse.player.botguardInitialized")||Jj);Sa("yt.abuse.player.invokeBotguard",B("yt.abuse.player.invokeBotguard")||Kj);Sa("yt.abuse.dclkstatus.checkDclkStatus",B("yt.abuse.dclkstatus.checkDclkStatus")||og);
Sa("yt.player.exports.navigate",B("yt.player.exports.navigate")||Zj);Sa("yt.util.activity.init",B("yt.util.activity.init")||Bg);Sa("yt.util.activity.getTimeSinceActive",B("yt.util.activity.getTimeSinceActive")||Eg);Sa("yt.util.activity.setTimestamp",B("yt.util.activity.setTimestamp")||Cg);}).call(this);
